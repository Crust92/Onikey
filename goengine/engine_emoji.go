/*
 * Onikey - A Vietnamese Input method editor
...
func (e *OnikeyEngine) openEmojiList() {
	e.emoji.ProcessKey(':')
...
func (e *OnikeyEngine) emojiProcessKeyEvent(keyVal uint32, keyCode uint32, state uint32) bool {
...
func (e *OnikeyEngine) updateCursorPosInEmojiTable(idx uint32) bool {
...
func (e *OnikeyEngine) updateEmojiLookupTable() {
...
func (e *OnikeyEngine) commitEmojiCandidate() {
	var cps = e.emoji.Query()
	if pos := e.emojiLookupTable.CursorPos; pos < uint32(len(cps)) {
...
func (e *OnikeyEngine) refreshEmojiCandidate() {
	var raw = e.emoji.GetRawString()
	var rawTextLen = len([]rune(raw))
	e.UpdatePreeditTextWithMode(ibus.NewText(raw), uint32(rawTextLen), true, ibus.IBUS_ENGINE_PREEDIT_COMMIT)
	e.UpdateAuxiliaryText(ibus.NewText(raw), true)
...
func (e *OnikeyEngine) closeEmojiCandidates() {
