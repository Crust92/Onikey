/*
 * Onikey - A Vietnamese Input method editor - Hexadecimal emulator
 * for Bamboo
...
func (e *OnikeyEngine) hexadecimalProcessKeyEvent(keyVal uint32, keyCode uint32, state uint32) bool {
...
func (e *OnikeyEngine) setupHexadecimalProcessKeyEvent() {
...
func (e *OnikeyEngine) closeHexadecimalInput() {
	e.HidePreeditText()
	e.preeditor.Reset()
	e.isInHexadecimal = false
}

func (e *OnikeyEngine) updateHexadecimal(processedStr string) {
